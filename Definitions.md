...
G
-
**global scope** The outermost scope, used to define and use global variables or other global constructs that shall be valid and visible to the compiler at all times.
U
-
