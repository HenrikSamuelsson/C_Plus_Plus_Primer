...
It will then be possible to do multiplication, subtraction, and addition without any problems with rounding errors. Note that there can still be rounding errors if division should be involved in the mortgage calculations, it is probably beyond the scope of this exercise to discuss this matter.  
